 ...
 *
 * Extended by Amol Nirmala Waman
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "minListOptions":
                        ...
                        break;
//                    case "numbersOnly":
//                        errorMsg = methods._numbersOnly(field, rules, i, options);
//                        break;
                    case "equals":
        ...
        /* AMOL'S JQUERY VALIDATIONS */
        /**
         * Max number of list options selected
         *
         * @param {jqObject} field
         * @param {Array[String]} rules
         * @param {int} i rules index
...
//        _numbersOnly: function(field, rules, i, options){
//          var groupname = field.attr("name");
//          var chkNum = $("input[name='" + groupname + "']").val();
//
//          if (chkNum.match(/[0-9]\d+$/)) {
//            var rule = options.allrules.numbersOnly;
//            return rule.alertText + chkNum + rule.alertText2;
//          }
//        },
        /* AMOL'S JQUERY VALIDATIONS ENDS */
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        // Is the form contained in an overflown container?
                        promptleftPosition += fieldWidth - 27; // top right prompt to the center of the checkbox
                    else {
